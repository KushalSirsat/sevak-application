...
import 'package:women_safety_app/Registration_page.dart';
       ...
       body:SingleChildScrollView(
          child: SizedBox(
            ...
            child: Stack(
                        children: <Widget>[
                          SizedBox(height: 20,),
                          Image.asset('images/login_page_vector_image.png',width: MediaQuery.of(context).size.width,height: MediaQuery.of(context).size.height/3,),
                                    ...
                                    Align(alignment: Alignment.topLeft,
                                      ...
                                      Padding(padding: EdgeInsets.only(left: 30,right: 10),
                                        child: TextField(keyboardType: TextInputType.emailAddress,textCapitalization: TextCapitalization.sentences,controller: email,
                                          decoration: InputDecoration(border: OutlineInputBorder(borderRadius: BorderRadius.circular(20.0),borderSide: BorderSide(color: Colors.deepPurple,width: 1)),prefixIcon: const Icon(Icons.email_rounded,color: Colors.deepPurpleAccent,),hintText: 'Email'),
                                      ...
                                      Padding(padding: EdgeInsets.only(left: 30,right: 10),
                                        child: TextField(keyboardType: TextInputType.visiblePassword,textCapitalization: TextCapitalization.sentences,controller: password,obscureText: !_passwordVisible,
                                          decoration: InputDecoration(border: OutlineInputBorder(borderRadius: BorderRadius.circular(20.0),borderSide: BorderSide(color: Colors.deepPurple,width: 1)),prefixIcon: const Icon(Icons.password_sharp,color: Colors.deepPurpleAccent,),hintText: 'Password',
                                        ...
                                        Align(alignment: Alignment.topLeft,
                                          child: SizedBox(
                                            ...
                                            child: Padding(padding: EdgeInsets.fromLTRB(30,20.0,30.0,00.0),
                                                child: ElevatedButton(onPressed:() {Navigator.push(context, scale_transition (child:Registration_page()));},style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Colors.deepPurpleAccent),shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(borderRadius:BorderRadius.circular(20.0)))),
                                                  child:  Text('Register',style: TextStyle(color: Colors.white,fontSize: 14.0,)),
                                                )
                                            ),
                                          ),
                                        ),
